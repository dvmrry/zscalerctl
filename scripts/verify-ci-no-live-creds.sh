...
pattern='(ZSCALERCTL_(CLIENT_[A-Z0-9_]*|VANITY_DOMAIN|CLOUD)|ZSCALER_[A-Z0-9_]*|ONEAPI_[A-Z0-9_]*|ZIA_[A-Z0-9_]*|ZPA_[A-Z0-9_]*|ZDX_[A-Z0-9_]*|ZCC_[A-Z0-9_]*|ZTC_[A-Z0-9_]*|ZTW_[A-Z0-9_]*|secrets\.[A-Z0-9_]*(ZSCALER|ONEAPI|ZIA|ZPA|ZDX|ZCC|ZTC|ZTW)[A-Z0-9_]*)'
fail=0
