...
| Zidentity | `resource-servers` | Staged as the thin read-only config slice; ordinary gates pass locally. | Run focused OneAPI live smoke before promotion; keep users/groups hard-deferred. |
