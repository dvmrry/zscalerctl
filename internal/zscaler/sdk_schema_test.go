...
func reviewedSDKShapes() []sdkShapeReview {
	...
	return []sdkShapeReview{
		...
		{
			name:         "zpaprivatecloudcontroller.PrivateCloudController",
			resource:     resources.ProductZPA,
			resourceName: resourceZPAPrivateClCtrs,
			typ:          reflect.TypeOf(zpaprivatecloudcontroller.PrivateCloudController{}),
			catalogFields: []string{
				"applicationStartTime",
				"controlChannelStatus",
				"creationTime",
				...
				"privateCloudControllerGroupName",
