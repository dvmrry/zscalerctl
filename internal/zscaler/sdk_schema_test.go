...
func reviewedSDKShapes() []sdkShapeReview {
	...
	return []sdkShapeReview{
		...
		{
			name:         "servergroup.ServerGroup",
			resource:     resources.ProductZPA,
			resourceName: resourceServerGroups,
			typ:          reflect.TypeOf(servergroup.ServerGroup{}),
			catalogFields: []string{
				"id",
				"enabled",
				"name",
		...
		{
			name: "servergroup.Applications",
			typ:  reflect.TypeOf(servergroup.Applications{}),
			ignoredFields: ignoredBecause(
				"covered by dropped applications parent",
				"id",
				"name",
			),
		},
		{
			name: "appconnectorgroup.AppConnectorGroup",
			typ:  reflect.TypeOf(appconnectorgroup.AppConnectorGroup{}),
			ignoredFields: ignoredBecause(
				"covered by dropped appConnectorGroups parent",
				"id",
				"name",
				"description",
				"enabled",
		...
		{
			name: "appservercontroller.ApplicationServer",
			typ:  reflect.TypeOf(appservercontroller.ApplicationServer{}),
			ignoredFields: ignoredBecause(
				"covered by dropped servers parent",
				"address",
				"appServerGroupIds",
				"configSpace",
				"creationTime",
		...
		{
			name: "zpacommon.ExtranetDTO",
			typ:  reflect.TypeOf(zpacommon.ExtranetDTO{}),
			ignoredFields: ignoredBecause(
				"covered by dropped extranetDTO parent",
				"locationDTO",
				"locationGroupDTO",
				"ziaErName",
				"zpnErId",
		...
		{
			name: "zpacommon.LocationDTO",
			typ:  reflect.TypeOf(zpacommon.LocationDTO{}),
			ignoredFields: ignoredBecause(
				"covered by dropped extranetDTO parent",
				"id",
				"name",
		...
		{
			name: "zpacommon.LocationGroupDTO",
			typ:  reflect.TypeOf(zpacommon.LocationGroupDTO{}),
			ignoredFields: ignoredBecause(
				"covered by dropped extranetDTO parent",
				"id",
				"name",
		...
		{
			name: "zpacommon.CommonSummary",
			typ:  reflect.TypeOf(zpacommon.CommonSummary{}),
			ignoredFields: ignoredBecause(
				"covered by dropped extranetDTO parent",
				"id",
				"name",
