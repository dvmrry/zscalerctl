...
func reviewedSDKShapes() []sdkShapeReview {
	...
	return []sdkShapeReview{
		...
		},
		{
			...
			resource:     resources.ProductZIA,
			resourceName: resourceC2CReceivers,
		...
		{
			name: "c2cincidentreceiver.LastValidationMsg",
			typ:  reflect.TypeOf(c2cincidentreceiver.LastValidationMsg{}),
			ignoredFields: ignoredBecause(
				"validation messages are covered by secret parent fields and may contain service-specific details",
				"errorMsg",
				"errorCode",
			),
		},
		{
			name: "c2cincidentreceiver.OnboardableEntity",
			typ:  reflect.TypeOf(c2cincidentreceiver.OnboardableEntity{}),
			ignoredFields: ignoredBecause(
				"onboardable entity metadata is covered by secret onboardableEntity parent until separately modeled",
				"id",
				"name",
				"type",
				"enterpriseTenantId",
		...
		{
			name: "c2cincidentreceiver.TenantAuthorizationInfo",
			typ:  reflect.TypeOf(c2cincidentreceiver.TenantAuthorizationInfo{}),
			ignoredFields: ignoredBecause(
				"tenant authorization payload is covered by secret onboardableEntity parent and contains credential-bearing fields",
				"accessToken",
				"botToken",
				"redirectUrl",
				"type",
		...
		{
			name: "c2cincidentreceiver.SmirBucketConfig",
			typ:  reflect.TypeOf(c2cincidentreceiver.SmirBucketConfig{}),
			ignoredFields: ignoredBecause(
				"SMIR bucket details are nested below a secret tenant authorization parent",
				"configName",
				"metadataBucketName",
				"dataBucketName",
				"id",
		...
		{
			name:         "dlpedm.DLPEDMSchema",
			resource:     resources.ProductZIA,
			resourceName: resourceDLPEDMSchemas,
			typ:          reflect.TypeOf(dlpedm.DLPEDMSchema{}),
			catalogFields: []string{
				"cellsUsed",
				"createdBy",
				"edmClient",
		...
		{
			name: "dlpedm.TokenList",
			typ:  reflect.TypeOf(dlpedm.TokenList{}),
			ignoredFields: ignoredBecause(
				"EDM token definitions are covered by secret tokenList parent until separately modeled",
				"name",
				"type",
				"primaryKey",
				"originalColumn",
		...
		{
			name: "dlpedm.Schedule",
			typ:  reflect.TypeOf(dlpedm.Schedule{}),
			ignoredFields: ignoredBecause(
				"EDM schedule fields are explicitly modeled in the dlp-edm-schemas catalog; this entry catches SDK additions",
				"scheduleType",
				"scheduleDayOfMonth",
				"scheduleDayOfWeek",
				"scheduleTime",
		...
		{
			name:         "dlpidmlite.DLPIDMProfileLite",
			resource:     resources.ProductZIA,
			resourceName: resourceDLPIDMLite,
			typ:          reflect.TypeOf(dlpidmlite.DLPIDMProfileLite{}),
			catalogFields: []string{
				"clientVm",
				"lastModifiedTime",
				"modifiedBy",
		...
		{
			name: "dlpwebrules.Receiver",
			typ:  reflect.TypeOf(dlpwebrules.Receiver{}),
			ignoredFields: ignoredBecause(
				"receiver details are covered by dropped receiver parent until separately modeled",
				"id",
				"name",
				"type",
				"tenant",
