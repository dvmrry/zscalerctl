	...
	return ResourceCatalog{
		...
		},
		{
			...
			Fields: []FieldSpec{
				...
				operationalField("customPhraseMatchType", allModes()),
				operationalField("nameL10nTag", allModes()),
				operationalField("custom", allModes()),
				operationalField("thresholdType", allModes()),
				operationalField("dictionaryType", allModes()),
				operationalField("proximity", standardShareModes()),
				...
				operationalField("predefinedCountActionType", allModes()),
		...
		},
		{
			...
			Fields: []FieldSpec{
				...
				sensitiveIdentifierField("url"),
				operationalField("status", allModes()),
				operationalField("flags", allModes()),
			},
		},
		{
			Product:    ProductZIA,
			...
			Fields: []FieldSpec{
				...
				tenantConfigField("name", standardShareModes()),
				secretField("subject"),
				operationalField("attachContent", allModes()),
				secretField("plainTextMessage"),
				secretField("htmlMessage"),
				operationalField("tlsEnabled", allModes()),
			},
		},
	}
}
